...
export const articleSubmissionService = {
   ...
   * @param articleId The ID of the article to submit
   ...
   * @param articleId The ID of the article to save (if exists)
   * @param formData The article data to save
   * @returns A result object with success status and article ID
   */
  saveDraft: async (
