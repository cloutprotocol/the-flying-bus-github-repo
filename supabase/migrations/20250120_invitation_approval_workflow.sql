-- Migration for Invitation Approval Workflow
-- This migration adds the necessary tables and triggers for the complete invitation workflow
...
CREATE INDEX idx_invitation_requests_notification_status ON invitation_requests(notification_status);
